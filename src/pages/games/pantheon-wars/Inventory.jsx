    ...
    >
      ...
      <main style={{ flex: 1, maxWidth: 640, margin: '0 auto', padding: '64px 20px', textAlign: 'center' }}>
        ...
        <p style={{
          ...
          Item loot, equipment, and consumables. Quest drops populate this vault once Phase B ships — every piece of loot you rolled but couldn't hold is tracked and waiting here.
        </p>
      </main>
    </motion.div>
  )

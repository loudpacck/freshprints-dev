    ...
    >
      ...
      <main style={{ flex: 1, maxWidth: 640, margin: '0 auto', padding: '64px 20px', textAlign: 'center' }}>
        ...
        <p style={{
          ...
          Attack other players, raid their resources, and climb the glory rankings. Slayers thrive here. Combat resolves via stat comparison with a random factor — no timing required, just the right build.
        </p>
      </main>
    </motion.div>
  )

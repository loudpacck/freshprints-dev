    ...
    >
      ...
      <main style={{ flex: 1, maxWidth: 640, margin: '0 auto', padding: '64px 20px', textAlign: 'center' }}>
        ...
        <p style={{
          ...
          Spend your drachma on weapons, artifacts, and consumables from the divine marketplace. Faction-specific stock rotates each cycle — Olympians, Aesir, and Annunaki vendors stock different catalogs.
        </p>
      </main>
    </motion.div>
  )
